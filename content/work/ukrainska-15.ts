...
const ukrainska15: CaseStudy = {
  ...
  outcome: {
    ...
    stamps: [
      { seal: "muse-gold",   label: "MUSE Creative Awards — Gold, Causes & Awareness", ratio: 3.035 },
      { seal: "muse-gold",   label: "MUSE Creative Awards — Gold, Strange & Unusual",   ratio: 3.035 },
      { seal: "cssda-ui",    label: "CSS Design Awards — Best UI",         ratio: 1 },
      { seal: "cssda-ux",    label: "CSS Design Awards — Best UX",         ratio: 1 },
      { seal: "cssda-inn",   label: "CSS Design Awards — Best Innovation", ratio: 1 },
      { seal: "cssda-kudos", label: "CSS Design Awards — Special Kudos",   ratio: 1 },
      { seal: "cssw-star",   label: "CSS Winner — Star",                   ratio: 1.286 },
      { mask: "nectar",      label: "CSS Nectar — Site of the Day",        ratio: 1.667 },
      { mask: "dn",          label: "Design Nominees — Site of the Day",   ratio: 3.286 },
      { text: "French Design Awards · Silver" },
    ],
  },
  ...
  sections: [
...

    {
      ...
      body: [
        ...
        [{ strong: "I would honour " }, { code: "prefers-reduced-motion" }, { strong: "." }, " The whole site runs on scroll-driven animation and it does not check whether the reader has asked their system to stop moving things. For a project this careful about not taking decisions away from the reader, that is the one place it does."],
      ],
    },
  ],
